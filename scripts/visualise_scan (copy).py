...
def callback(data):
    ...
    for r in data.ranges:
        ...
        if -way_m*pi/180 < angle < way_m*pi/180:
            cv2.line(frame, (x + mid_frame - 1, y + ymid_frame-2), (x + mid_frame, y + ymid_frame), (20, 255, 255), 4)  # Y
            cv2.line(frame, (mid_frame, ymid_frame), (mid_frame + thres_nx, ymid_frame + thres_ny), (44, 44, 107), 1)  # red
            cv2.line(frame, (mid_frame + thres_nx, ymid_frame + thres_ny), (mid_frame + thres_mx, ymid_frame + thres_my), (40, 100, 100), 1)  # Y
            if r > thres_m:
            ...
            cv2.line(frame, (x + mid_frame - 1, y + ymid_frame-2), (x + mid_frame, y + ymid_frame), (20, 20, 255), 4)  # red
            cv2.line(frame, (mid_frame, ymid_frame), (mid_frame + thres_nx, ymid_frame + thres_ny), (44, 44, 107), 1)  # red
            if thres_n < r:
        ...
        cv2.line(frame, (x1 + mid_frame - 1, y1 + ymid_frame-1), (x1 + mid_frame, y1 + ymid_frame), (55, 55, p1), 1)  # red
        ######################################################################
        ######################################################################
        cir = thres_n
        x1 = math.trunc((cir * 2 * size) * math.cos(angle + (-90 * pi / 180)))
